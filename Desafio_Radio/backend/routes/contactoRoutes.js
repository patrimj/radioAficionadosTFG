...
router.get('/contacto/usuarios', [validarJWT, ], controladorContacto.getUsuarios);
...
router.get('/contacto/concursos', [validarJWT, ], controladorContacto.getConcursosContacto);

// MOSTRAR SOLUCIÓN CONCURSO

router.get('/contacto/concurso/solucion/:id_principal', [validarJWT, ], controladorContacto.getSolucionConcurso);
...
router.get('/contacto/actividad/premio/:id_secundaria', [validarJWT, ], controladorContacto.getPremioActividad);
