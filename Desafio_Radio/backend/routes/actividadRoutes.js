...
// VER ACTIVIDADES PROPIAS (PATRICIA)

router.get('/aficionado/principales', [midsJWT.validarJWT], controladorActividad.getActividadesPrincipalesAficionado);

router.get('/aficionado/secundarias', [midsJWT.validarJWT], controladorActividad.getActividadesSecundariasAficionado);
